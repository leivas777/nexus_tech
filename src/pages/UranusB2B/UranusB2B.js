...
import styles from "./UranusB2B.module.css";
import uranusB2BLogo from "../../assets/Uranus1.png";
        ...
        <main className={styles.main} role="main" aria-label="Uranus B2B">
            <section className={styles.card} aria-labelledby="page-title">
                <header className={styles.mainTitle}>
                    ...
                    <h1 id="page-title">Uranus B2B</h1>
                </header>
                <p className={styles.mainSubtitle}>Organize as cobranças da sua empresa</p>
            </section>
            ...
            <section className={styles.card} aria-labelledby="dashboard-title">
                <h2 id="dashboard-title" className={styles.divTitle}>Dashboard Cobranças</h2>
