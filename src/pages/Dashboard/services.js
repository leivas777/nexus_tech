...
export default function ServicesPage() {
  ...
  if (loading)
    return <div className="p-10 text-center">Carregando serviços...</div>;
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <form
        ...
        className="bg-white p-4 rounded-lg shadow-md mb-8 grid grid-cols-1 md:grid-cols-4 gap-4 items-end"
      >
        <div>
