  ...
  return (
    ...
    >
      ...
      <div className={styles.stepArea}>
        ...
        {step === 1 && <StepSegmento form={form} updateField={updateField} />}
        {step === 2 && <StepDesafios form={form} updateField={updateField} />}
        {step === 3 && (
...
function StepDadosBasicos({ form, updateField }) {
  return (
    <div className={styles.grid}>
      ...
      <small id="termos-desc" className={styles.helper}>
